                    ...
                    <div className="flex flex-col gap-6">
                        <div className="p-6 md:p-8 bg-[#0f0f0f] border border-white/10 rounded-xl">
                            <div className="space-y-5">
                                    ...
                                    <div className="ml-13 pl-13 space-y-1">
                                        {BRAND.phones.map((p) => (
                                            <a
                                                key={p.tel}
                                                href={`tel:${p.tel}`}
                                                className="block text-white text-base hover:text-[var(--hs-red)] transition-colors"
                                            >
                                                {p.label}
                                            </a>
                                        ))}
                                ...
                                >
                                    <div
                                        className="w-10 h-10 flex-shrink-0 rounded text-white flex items-center justify-center"
                                        style={{
                                            background:
